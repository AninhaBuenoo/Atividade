                ...
                <div class="my-4">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $venda) : ?>
                            <tr>
                                <td><?= $venda->getId() ?></td>
                                <?php $data = $venda->getData() ?>
                                <td><?= date("d/m/Y", strtotime($data)) ?></td>
                                <td><?= $venda->getCliente() ?></td>
                                <td><?= $venda->getUsuario() ?></td>
                                <td>
                                    <a class="link link-success" href="../venda_produto/create.php?id=<?= $venda->getId() ?>" title="Adicionar Produtos">
                                        <i class="bi bi-cart"></i>
                                    </a>
                                    <a href="edit.php?id=<?= $venda->getId() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $venda->getId() ?>" title="Excluir">
