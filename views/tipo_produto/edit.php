<?php
    // Buscar as informações do TipoProduto para atualizar
    require "../../autoload.php";

    $dao = new TipoProdutoDAO();
    $TipoProduto = $dao->find($_GET['id']);
?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Editar Tipo Produto</h2>
                    <form action="update.php" method="post">
                        <p class="form-group">
                            <label for="descricao">Descrição</label>
                            <input type="text" name="descricao" class="form-control" value="<?= $tipoProduto->getDescricao() ?>">
                        </p>
                        <input type="hidden" name="id" value="<?= $tipoProduto->getId() ?>">
                        <p class="form-group">
