    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Tipo Produtos</h2>
                    <a href="create.php">Novo Tipo Produto</a>
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $tipoProduto) : ?>
                            <tr>
                                <td><?= $tipoProduto->getId() ?></td>
                                <td><?= $tipoProduto->getDescricao() ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $tipoProduto->getId() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $tipoProduto->getId() ?>" title="Excluir">
